      ...
      <IonContent className="ion-padding">
        ...
        <section className='mt-5 ion-padding'>
          ...
          <form action="">
            ...
            <div className='form_inputs ion-margin-vertical'>
              ...
              <IonInput type='password' placeholder='Enter your Email' className='mt-2 p-2' />
              <IonIcon icon={eyeOffOutline} className='input_icon' size='large' slot='end' />
        ...
        <section className='mt-4'>
          ...
          <SpaceBetween className='mt-3 mx-auto ion-padding-horizontal'>
            <IonButton shape='round' className='nm_btn'>
